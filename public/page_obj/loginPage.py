...
class login(Page):
    ...
    dig_login_button_loc2 = (By.ID, testData.get_elementinfo(1))
    ...
    # 定位器，通过元素属性定位元素对象
    # 手机号输入框
    login_phone_loc = (By.ID, testData.get_elementinfo(2))
    # 密码输入框
    login_password_loc = (By.ID, testData.get_elementinfo(3))
    # 取消自动登录
    ...
    # 二次确认退出
    twice_login_exit_button_loc = (By.XPATH, testData.get_elementinfo(7))
    ...
    def login_exit(self):
        ...
        self.find_element(*self.twice_login_exit_button_loc).click()
    ...
    phone_pawd_error_hint_loc = (By.XPATH, testData.get_CheckElementinfo(1))
    user_login_success_loc = (By.ID, testData.get_CheckElementinfo(2))
    exit_login_success_loc = (By.XPATH, testData.get_CheckElementinfo(3))
