...
from public.models.GetExecl import getexcel

testData = getexcel(setting_execl.TEST_Element_EXECL, 'login.xlsx', 'testcase')
...
class login(Page):
    ...
    testData = getexcel(setting_execl.TEST_Element_EXECL, 'login.xlsx', 'check')
